			...
			<div className="page-header">
				...
				<nav aria-label="breadcrumb">
					{ activeComponent && activeComponent != 'Profile' ?
						<Link to='/internalSupervisor/profile' className="btn btn-social-icon-text btn-linkedin"><i className="mdi mdi-arrow-left-bold btn-icon-prepend"></i>&nbsp; Back</Link> : false
					}
				</nav>
			</div>
			<div className="row">
				<div className="col-lg-12 grid-margin stretch-card">
						...
						<Switch>
							<Route exact path='/internal-supervisor/profile' > <Profile /> </Route>
