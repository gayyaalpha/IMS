...
function StudentForm(props){
    ...
    useEffect(() => {
        if(props.isEdit){
            ...
            myDispatch(setActiveComponent('AddStudent'));
        }
    }, []);
                ...
                .then(response => {
                    ...
                    if (response.data.status == 'validation-error') {
                        ...
                        showSznNotification({
                            type : 'success',
                            message : response.data.message,
                            student_id : response.data.result?.id,
                        });
                        history.push('/student/edit/'+response.data.result?.id)
                    }
                })
                .catch((error) => {
                    console.log(error);
                                        ...
                                        <div className="form-group">
                                            <ul className="nav nav-tabs nav-pills c--nav-pills nav-justified">
                                                <li className="nav-item">
                                                    <span className="nav-link btn btn-gradient-primary btn-block active">{props?.isEdit? 'EDIT':'Add'} Student</span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="form-group">
