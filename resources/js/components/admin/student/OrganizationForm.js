...
function OrganizationForm(props) {
    ...
    useEffect(()=>{
        if(studentOrganization){
            ...
            setState({
                ...state,
                registration_number:studentOrganization?.organization?.registration_number,label:studentOrganization?.organization?.registration_number,
                                    ...
                                    <form className="edit-lead-form border" onSubmit={onSubmitHandle}>
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="input-group input-group-sm">
                                                ...
                                                <input readOnly={true} type="text" className="form-control form-control-sm" id="registration_number" name="registration_number" placeholder="Registration Number"
                                        ...
                                        <div className="form-group text-center">
                                            ...
                                            <Link to={`/student/edit/${student.id}`} className="btn btn-inverse-secondary btn-md">Cancel</Link>
                                        </div>
                                    </form>
                                </LoadingOverlay>
                            </div>
