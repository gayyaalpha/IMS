...
import ProfileCard from "../internalSupervisor/ProfileCard";
            ...
            <div className="card animated fadeIn">
                ...
                <div className="card animated fadeIn">
                    <div className="card-body">
                        ...
                        <div className='szn-list-wrapper bg-gradient-light'>
                            <ProfileCard obj={{
                                title:internalSupervisor?.title,
                                name:internalSupervisor?.name,
                                id:internalSupervisor?.id,
                                email:internalSupervisor?.email,
                                phone:internalSupervisor?.contact_no_home,
                                description:internalSupervisor?.description,
                                status:internalSupervisor?.status
                            }}/>
                        </div>
                    </div>
                </div>
